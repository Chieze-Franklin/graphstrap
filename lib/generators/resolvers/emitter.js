...
class Emitter {
    ...
    _emitMutationExtension(node, name) {
        ...
        this.mutationResolvers.members.push({
            ...
            signature: {
                type: 'reference',
                target: `__Resolver<{}, ${name}CreateOneMutationArgs, ${name}>`
            }
        }, {
            type: 'property',
            ...
            signature: {
                type: 'reference',
                target: `__Resolver<{}, ${name}FindOneQueryArgs, ${name}>`
            }
        }, {
            type: 'property',
            ...
            signature: {
                type: 'reference',
                target: `__Resolver<{}, ${name}DeleteManyMutationArgs, ${name}[]>`
            }
        }, {
            type: 'property',
            ...
            signature: {
                type: 'reference',
                target: `__Resolver<{}, ${name}UpdateOneMutationArgs, ${name}>`
            }
        }, {
            type: 'property',
            ...
            signature: {
                type: 'reference',
                target: `__Resolver<{}, ${name}UpdateManyMutationArgs, ${name}[]>`
            }
        }, {
            type: 'property',
            ...
            signature: {
                type: 'reference',
                target: `__Resolver<{}, ${name}UpsertOneMutationArgs, ${name}>`
            }
        });
    }
    _emitQueryExtension(node, name) {
        ...
        this.queryResolvers.members.push({
            ...
            signature: {
                type: 'reference',
                target: `__Resolver<{}, ${name}FindManyQueryArgs, ${name}[]>`
            }
        });
    }
    _emitUnion(node) {
