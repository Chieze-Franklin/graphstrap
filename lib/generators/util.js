...
exports.isNodeExported = exports.foundSchema = exports.documentationForNode = void 0;
...
function foundSchema(schemaRootPath) {
    ...
    typescript_1.default.forEachChild(schemaRoot, (node) => {
        ...
        if (node.kind === typescript_1.default.SyntaxKind.InterfaceDeclaration) {
            ...
            if (documentation && lodash_1.default.find(documentation.tags, { title: 'graphql', description: 'schema' })) {
                foundSchema = true;
            }
        }
    });
