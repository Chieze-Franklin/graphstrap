...
class Emitter {
    emitQuery(stream, name) {
        stream.write(`/*\nThis files will be generated by ${console_message_1.ConsoleMessage.TITLE} pnly if it does NOT exist\n*/\n`);
